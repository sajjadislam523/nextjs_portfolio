            ...
            <div className="container">
                ...
                <div className="max-w-lg mx-auto">
                    ...
                    <p className="mt-4 text-center text-white/60 md:text-lg">
                        ...
                        high-performing web applications. Let&apos;s discuss
                        your next project.
                    </p>
                </div>
                <div className="flex flex-col md:flex-row justify-center gap-4 items-center mt-8">
                    ...
                    <button className="inline-flex items-center h-12 px-6 rounded-xl gap-2 border border-white bg-white text-gray-900">
                        <span>✌️</span>
                        <span className="font-semibold">
                            Let&apos;s Connect
                        </span>
